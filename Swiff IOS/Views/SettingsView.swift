...
struct SettingsView: View {
    ...
    @State private var selectedResolution: RestoreOptions.ConflictResolution = RestoreOptions.ConflictResolution.replaceWithBackup
    ...
    var body: some View {
        NavigationView {
            List {
                ...
                Section {
                    ...
                    Toggle(isOn: $userSettings.subscriptionReminders) {
                        VStack(alignment: .leading, spacing: 4) {
                            Text("Subscription Renewals")
                                .font(.spotifyBodyMedium)
                                .foregroundColor(.wisePrimaryText)
                            Text("Remind me before subscriptions renew")
                                .font(.spotifyCaptionMedium)
                                .foregroundColor(.wiseSecondaryText)
                        }
                    }
                    ...
                    Toggle(isOn: $userSettings.paymentReminders) {
                        VStack(alignment: .leading, spacing: 4) {
                            Text("Payment Reminders")
                                .font(.spotifyBodyMedium)
                                .foregroundColor(.wisePrimaryText)
                            Text("Remind me about pending payments")
                                .font(.spotifyCaptionMedium)
                                .foregroundColor(.wiseSecondaryText)
                        }
                    }
                    ...
                    // AGENT 7: Test Notification Button
                    Button(action: {
                        Task {
                    ...
                    // AGENT 7: Notification History Link
        ...
        .alert("Restore Completed", isPresented: $showingRestoreSuccess) {
            ...
            if let stats = restoreStatistics {
                Text("Successfully imported \(stats.recordsImported) records, skipped \(stats.recordsSkipped), replaced \(stats.recordsReplaced).")
            } else {
            ...
            List {
                ...
                Section {
                    ...
                    VStack(alignment: .leading, spacing: 8) {
                        ...
                        Label("\(dataManager.subscriptionsCount) subscriptions", systemImage: "creditcard.fill")
                        Label("\(dataManager.transactionsCount) transactions", systemImage: "list.bullet")
                    }
                    .font(.spotifyBodySmall)
                    .foregroundColor(.wisePrimaryText)
                }
