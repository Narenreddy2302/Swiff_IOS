...
extension Theme {
    ...
    public struct Colors {
        ...
        // MARK: - Requested Accent Colors
        public static let accentLight = Color(red: 238 / 255, green: 242 / 255, blue: 227 / 255)  // #EEF2E3
        public static let accentLightMedium = Color(
            red: 201 / 255, green: 212 / 255, blue: 183 / 255)  // #C9D4B7
        public static let accentMedium = Color(red: 137 / 255, green: 167 / 255, blue: 106 / 255)  // #89A76A
        public static let accentDarkMedium = Color(red: 87 / 255, green: 116 / 255, blue: 68 / 255)  // #577444
        public static let accentDark = Color(red: 4 / 255, green: 63 / 255, blue: 46 / 255)  // #043F2E

        // MARK: - Brand Colors (Adaptive for Dark Mode)
        /// Primary brand color - dark green in light mode, bright lime in dark mode
        public static let brandPrimary = Color(light: accentDark, dark: green3)

        /// Secondary brand color - medium green in light mode, lime highlight in dark mode
        public static let brandSecondary = Color(light: accentMedium, dark: accentLightMedium)
        ...
        public static let warning = Color(
            ...
            dark: Color(red: 1.0, green: 0.700, blue: 0.100))
        public static let systemError = Color(
            light: Color(red: 1.0, green: 0.271, blue: 0.227),
            dark: Color(red: 1.0, green: 0.400, blue: 0.400))

        public static let info = Color(
            light: Color(red: 0.039, green: 0.518, blue: 1.0),
            dark: Color(red: 0.400, green: 0.700, blue: 1.0))
