...
public enum SubscriptionEventType: String, Codable {
    ...
    public var bubbleType: BubbleType {
        switch self {
        case .billingCharged:
...
public struct SubscriptionEvent: Identifiable, Codable {
    public var id: UUID = UUID()
    public var subscriptionId: UUID
    public var eventType: SubscriptionEventType
    ...
    public var relatedPersonId: UUID?
    ...
    public var formattedDate: String {
        ...
        if calendar.isDateInToday(eventDate) {
            ...
            return "Yesterday"
        } else if let daysAgo = calendar.dateComponents([.day], from: eventDate, to: now).day,
            daysAgo < 7
        {
            let formatter = DateFormatter()
    ...
    public static func sectionDate(for date: Date) -> String {
        let calendar = Calendar.current
    ...
    public static func groupByDate(_ events: [SubscriptionEvent]) -> [(
        date: Date, events: [SubscriptionEvent]
    )] {
        let calendar = Calendar.current
