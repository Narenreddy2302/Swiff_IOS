...
struct MockData {
    ...
    static var longNameSubscription: Subscription = {
        var sub = Subscription(
            ...
            description:
                "Full access to all NYT content including archives, games, cooking, and print delivery",
            price: 45.00,
            billingCycle: .monthly,
            category: .news,
            icon: "newspaper.fill",
    ...
    static var largeGroup: Group = {
        ...
        group.expenses = [
            GroupExpense(
                ...
                paidBy: personId1,
                splitBetween: [
                    personId1, personId2, personId3, personId4, personId5, personId6, personId7,
                ],
                category: .entertainment
            )
        ]
...
extension MockData {
    ...
    static var htFriend1: Person = {
        var p = Person(
            name: "Emma Wilson", email: "emma.wilson@email.com", phone: "+1 (555) 010-1001",
            avatarType: .emoji("👩‍💼"), relationshipType: "Friend")
        p.id = htPersonId01
        p.balance = 78.25
        p.notes = "College roommate"
        return p
    }()

    static var htFriend2: Person = {
        var p = Person(
            name: "James Chen", email: "james.chen@email.com", phone: "+1 (555) 010-1002",
            avatarType: .initials("JC", colorIndex: 1), relationshipType: "Friend")
        p.id = htPersonId02
        p.balance = -45.50
        p.notes = "Basketball buddy"
        return p
    }()

    static var htFriend3: Person = {
        var p = Person(
            name: "Aisha Patel", email: "aisha.p@email.com", phone: "+1 (555) 010-1003",
            avatarType: .initials("AP", colorIndex: 2), relationshipType: "Friend")
        p.id = htPersonId03
        p.balance = 0.0
        p.notes = "Settled up"
        return p
    ...
    static var htFriend4: Person = {
        var p = Person(
            name: "David Kim", email: "david.kim@email.com", phone: "+1 (555) 010-1004",
            avatarType: .emoji("👨‍🎤"), relationshipType: "Friend")
        p.id = htPersonId04
        p.balance = 120.00
        p.notes = "Owes from trip"
        return p
    }()

    static var htFriend5: Person = {
        var p = Person(
            name: "Olivia Martinez", email: "olivia.m@email.com", phone: "+1 (555) 010-1005",
            avatarType: .emoji("👩‍🎨"), relationshipType: "Friend")
        p.id = htPersonId05
        p.balance = -89.75
        p.notes = "Concert tickets"
        return p
    }()

    static var htFriend6: Person = {
        var p = Person(
            name: "Lucas Brown", email: "lucas.b@email.com", phone: "+1 (555) 010-1006",
            avatarType: .initials("LB", colorIndex: 3), relationshipType: "Friend")
        p.id = htPersonId06
        p.balance = 32.50
        p.notes = "Dinner split"
        return p
    }()

    static var htFriend7: Person = {
        var p = Person(
            name: "Sophia Anderson", email: "sophia.a@email.com", phone: "+1 (555) 010-1007",
            avatarType: .emoji("👩‍🔬"), relationshipType: "Friend")
        p.id = htPersonId07
        p.balance = -15.00
        p.notes = "Coffee runs"
    ...
    static var htFamily1: Person = {
        var p = Person(
            name: "Patricia (Mom)", email: "mom@family.com", phone: "+1 (555) 020-2001",
            avatarType: .emoji("👩‍👧"), relationshipType: "Family")
        p.id = htPersonId08
        p.balance = 0.0
        p.notes = "Family account"
        return p
    }()

    static var htFamily2: Person = {
        var p = Person(
            name: "Robert (Dad)", email: "dad@family.com", phone: "+1 (555) 020-2002",
            avatarType: .emoji("👨‍👧"), relationshipType: "Family")
        p.id = htPersonId09
        p.balance = 500.00
        p.notes = "Holiday gift"
        return p
    }()

    static var htFamily3: Person = {
        var p = Person(
            name: "Jennifer (Sister)", email: "jen@family.com", phone: "+1 (555) 020-2003",
            avatarType: .emoji("👩"), relationshipType: "Family")
        p.id = htPersonId10
        p.balance = -75.00
        p.notes = "Shared Netflix"
        return p
    }()

    static var htFamily4: Person = {
        var p = Person(
            name: "Michael (Brother)", email: "mike@family.com", phone: "+1 (555) 020-2004",
            avatarType: .emoji("👨"), relationshipType: "Family")
        p.id = htPersonId11
        p.balance = 150.00
        p.notes = "Borrowed money"
        return p
    }()

    static var htFamily5: Person = {
        var p = Person(
            name: "Rachel (Cousin)", email: "rachel@family.com", phone: "+1 (555) 020-2005",
            avatarType: .initials("RC", colorIndex: 4), relationshipType: "Family")
        p.id = htPersonId12
        p.balance = -25.00
        p.notes = "Birthday dinner"
        return p
    }()
    ...
    static var htCoworker1: Person = {
        var p = Person(
            name: "Sarah Johnson", email: "sarah.j@work.com", phone: "+1 (555) 030-3001",
            avatarType: .initials("SJ", colorIndex: 5), relationshipType: "Coworker")
        p.id = htPersonId13
        p.balance = 23.45
        p.notes = "Lunch buddy"
        return p
    ...
    static var htCoworker2: Person = {
        var p = Person(
            name: "Alex Thompson", email: "alex.t@work.com", phone: "+1 (555) 030-3002",
            avatarType: .emoji("👨‍💻"), relationshipType: "Coworker")
        p.id = htPersonId14
        p.balance = -67.80
        p.notes = "Team lunch"
        return p
    ...
    static var htCoworker3: Person = {
        var p = Person(
            name: "Chris Williams", email: "chris.w@work.com", phone: "+1 (555) 030-3003",
            avatarType: .initials("CW", colorIndex: 6), relationshipType: "Coworker")
        p.id = htPersonId15
        p.balance = 0.0
        p.notes = "Settled"
        return p
    ...
    static var htCoworker4: Person = {
        var p = Person(
            name: "Morgan Lee", email: "morgan.l@work.com", phone: "+1 (555) 030-3004",
            avatarType: .emoji("👩‍💼"), relationshipType: "Coworker")
        p.id = htPersonId16
        p.balance = 42.00
        p.notes = "Coffee fund"
    ...
    static var htCoworker5: Person = {
        var p = Person(
            name: "Taylor Davis", email: "taylor.d@work.com", phone: "+1 (555) 030-3005",
            avatarType: .initials("TD", colorIndex: 7), relationshipType: "Coworker")
        p.id = htPersonId17
        p.balance = -18.50
        p.notes = "Snack run"
        return p
    ...
    static var htOther1: Person = {
        var p = Person(
            name: "Dr. Amanda Foster", email: "dr.foster@clinic.com", phone: "+1 (555) 040-4001",
            avatarType: .emoji("👩‍⚕️"), relationshipType: "Other")
        p.id = htPersonId18
        p.balance = -200.00
        p.notes = "Medical copay"
        return p
    }()

    static var htOther2: Person = {
        var p = Person(
            name: "Jake (Personal Trainer)", email: "jake@fitgym.com", phone: "+1 (555) 040-4002",
            avatarType: .emoji("🏋️"), relationshipType: "Other")
        p.id = htPersonId19
        p.balance = -150.00
        p.notes = "Session fee"
    ...
    static var htOther3: Person = {
        var p = Person(
            name: "Mr. Chen (Landlord)", email: "landlord@building.com", phone: "+1 (555) 040-4003",
            avatarType: .initials("MC", colorIndex: 0), relationshipType: "Other")
        p.id = htPersonId20
        p.balance = 0.0
        p.notes = "Rent always on time"
        return p
    }()
    ...
    static var htSub01: Subscription = {
        var s = Subscription(
            name: "Netflix Premium", description: "4K streaming with 4 screens", price: 22.99,
            billingCycle: .monthly, category: .entertainment, icon: "tv.fill", color: "#E50914")
        s.id = htSubId01
        s.isActive = true
        s.isShared = true
        s.sharedWith = [htPersonId01, htPersonId02, htPersonId03]
    ...
    static var htSub02: Subscription = {
        var s = Subscription(
            name: "Spotify Family", description: "Premium family plan - 6 accounts", price: 16.99,
            billingCycle: .monthly, category: .music, icon: "music.note", color: "#1DB954")
        s.id = htSubId02
        s.isActive = true
        s.isShared = true
        s.sharedWith = [htPersonId08, htPersonId09, htPersonId10, htPersonId11]
    ...
    static var htSub03: Subscription = {
        var s = Subscription(
            name: "Disney+ Bundle", description: "Disney+, Hulu, ESPN+", price: 13.99,
            billingCycle: .monthly, category: .entertainment, icon: "sparkles.tv", color: "#113CCF")
        s.id = htSubId03
        s.isActive = true
    ...
    static var htSub04: Subscription = {
        var s = Subscription(
            name: "HBO Max", description: "Ad-free streaming", price: 15.99, billingCycle: .monthly,
            category: .entertainment, icon: "play.tv", color: "#5822B4")
        s.id = htSubId04
        s.isActive = true
        s.createdDate = Calendar.current.date(byAdding: .month, value: -4, to: Date())!
        s.lastUsedDate = Calendar.current.date(byAdding: .day, value: -5, to: Date())!
        s.usageCount = 15
        return s
    }()
    ...
    static var htSub05: Subscription = {
        var s = Subscription(
            name: "Apple TV+", description: "Original shows", price: 9.99, billingCycle: .monthly,
            category: .entertainment, icon: "appletv", color: "#000000")
        s.id = htSubId05
        s.isActive = true
        s.isShared = true
        s.sharedWith = [htPersonId04, htPersonId05]
    ...
    static var htSub06: Subscription = {
        var s = Subscription(
            name: "YouTube Premium", description: "Ad-free videos + music", price: 13.99,
            billingCycle: .monthly, category: .entertainment, icon: "play.rectangle.fill",
            color: "#FF0000")
        s.id = htSubId06
        s.isActive = true
    ...
    static var htSub07: Subscription = {
        var s = Subscription(
            name: "Hulu", description: "Cancelled streaming", price: 17.99, billingCycle: .monthly,
            category: .entertainment, icon: "play.circle", color: "#1CE783")
        s.id = htSubId07
        s.isActive = false
        s.cancellationDate = Calendar.current.date(byAdding: .day, value: -30, to: Date())
    ...
    static var htSub08: Subscription = {
        var s = Subscription(
            name: "Paramount+", description: "7-day free trial", price: 5.99,
            billingCycle: .monthly, category: .entertainment, icon: "star.circle.fill",
            color: "#0064FF")
        s.id = htSubId08
        s.isFreeTrial = true
        s.trialStartDate = Date()
        s.trialEndDate = Calendar.current.date(byAdding: .day, value: 7, to: Date())
        s.trialDuration = 7
        s.willConvertToPaid = true
        s.priceAfterTrial = 5.99
        s.createdDate = Date()
        return s
    }()
    ...
    static var htSub09: Subscription = {
        var s = Subscription(
            name: "Microsoft 365", description: "Office apps + 1TB OneDrive", price: 99.99,
            billingCycle: .annually, category: .productivity, icon: "doc.fill", color: "#0078D4")
        s.id = htSubId09
        s.isActive = true
        s.isShared = true
        s.sharedWith = [htPersonId08, htPersonId09, htPersonId10, htPersonId11, htPersonId12]
    ...
    static var htSub10: Subscription = {
        var s = Subscription(
            name: "Adobe Creative Cloud", description: "Full creative suite", price: 54.99,
            billingCycle: .monthly, category: .design, icon: "paintbrush.fill", color: "#FF0000")
        s.id = htSubId10
        s.isActive = true
        s.createdDate = Calendar.current.date(byAdding: .month, value: -18, to: Date())!
        s.lastUsedDate = Calendar.current.date(byAdding: .day, value: -1, to: Date())!
    ...
    static var htSub11: Subscription = {
        var s = Subscription(
            name: "Notion Pro", description: "Unlimited workspace", price: 8.00,
            billingCycle: .monthly, category: .productivity, icon: "doc.text", color: "#000000")
        s.id = htSubId11
        s.isActive = true
        s.createdDate = Calendar.current.date(byAdding: .month, value: -6, to: Date())!
        s.lastUsedDate = Date()
    ...
    static var htSub12: Subscription = {
        var s = Subscription(
            name: "Figma Pro", description: "Design collaboration", price: 15.00,
            billingCycle: .monthly, category: .design, icon: "pencil.and.ruler", color: "#F24E1E")
        s.id = htSubId12
        s.isActive = true
        s.createdDate = Calendar.current.date(byAdding: .month, value: -12, to: Date())!
        s.lastUsedDate = Calendar.current.date(byAdding: .day, value: -3, to: Date())!
        s.usageCount = 60
        return s
    }()
    ...
    static var htSub13: Subscription = {
        var s = Subscription(
            name: "Slack Pro", description: "Team communication", price: 8.75,
            billingCycle: .monthly, category: .productivity, icon: "bubble.left.and.bubble.right",
            color: "#4A154B")
        s.id = htSubId13
        s.isActive = true
    ...
    static var htSub14: Subscription = {
        var s = Subscription(
            name: "Zoom Pro", description: "Video conferencing - Paused", price: 15.99,
            billingCycle: .monthly, category: .productivity, icon: "video.fill", color: "#2D8CFF")
        s.id = htSubId14
        s.isActive = false
    ...
    static var htSub15: Subscription = {
        var s = Subscription(
            name: "Gym Membership", description: "24 Hour Fitness access", price: 49.99,
            billingCycle: .monthly, category: .fitness, icon: "figure.walk", color: "#FF6B35")
        s.id = htSubId15
        s.isActive = true
        s.usageCount = 18
        s.createdDate = Calendar.current.date(byAdding: .month, value: -8, to: Date())!
    ...
    static var htSub16: Subscription = {
        var s = Subscription(
            name: "Headspace", description: "Meditation & mindfulness", price: 12.99,
            billingCycle: .monthly, category: .health, icon: "brain.head.profile", color: "#FF6B00")
        s.id = htSubId16
        s.isActive = true
        s.usageCount = 25
    ...
    static var htSub17: Subscription = {
        var s = Subscription(
            name: "Strava Premium", description: "Advanced running analytics", price: 11.99,
            billingCycle: .monthly, category: .fitness, icon: "figure.run", color: "#FC4C02")
        s.id = htSubId17
        s.isActive = true
        s.usageCount = 12
        s.createdDate = Calendar.current.date(byAdding: .month, value: -4, to: Date())!
    ...
    static var htSub18: Subscription = {
        var s = Subscription(
            name: "MyFitnessPal Premium", description: "Nutrition tracking", price: 79.99,
            billingCycle: .annually, category: .health, icon: "fork.knife", color: "#0066CC")
        s.id = htSubId18
        s.isActive = true
        s.createdDate = Calendar.current.date(byAdding: .month, value: -10, to: Date())!
        s.lastUsedDate = Date()
    ...
    static var htSub19: Subscription = {
        var s = Subscription(
            name: "iCloud+ 200GB", description: "Family sharing enabled", price: 2.99,
            billingCycle: .monthly, category: .cloud, icon: "icloud.fill", color: "#007AFF")
        s.id = htSubId19
        s.isActive = true
        s.isShared = true
        s.sharedWith = [htPersonId08, htPersonId09, htPersonId10, htPersonId11, htPersonId12]
    ...
    static var htSub20: Subscription = {
        var s = Subscription(
            name: "Google One 2TB", description: "Cloud storage + VPN", price: 9.99,
            billingCycle: .monthly, category: .cloud, icon: "externaldrive.fill.badge.icloud",
            color: "#4285F4")
        s.id = htSubId20
        s.isActive = true
        s.createdDate = Calendar.current.date(byAdding: .month, value: -24, to: Date())!
    ...
    static var htSub21: Subscription = {
        var s = Subscription(
            name: "Dropbox Plus", description: "2TB cloud storage", price: 11.99,
            billingCycle: .monthly, category: .cloud, icon: "externaldrive.fill", color: "#0061FF")
        s.id = htSubId21
        s.isActive = true
    ...
    static var htSub22: Subscription = {
        var s = Subscription(
            name: "1Password Family", description: "Password manager for family", price: 4.99,
            billingCycle: .monthly, category: .utilities, icon: "lock.fill", color: "#1A8CFF")
        s.id = htSubId22
        s.isActive = true
        s.isShared = true
        s.sharedWith = [htPersonId08, htPersonId09, htPersonId10, htPersonId11, htPersonId12]
    ...
    static var htSub23: Subscription = {
        var s = Subscription(
            name: "NY Times Digital", description: "All Access subscription", price: 17.00,
            billingCycle: .monthly, category: .news, icon: "newspaper.fill", color: "#000000")
        s.id = htSubId23
        s.isActive = true
    ...
    static var htSub24: Subscription = {
        var s = Subscription(
            name: "The Athletic", description: "Sports journalism", price: 9.99,
            billingCycle: .monthly, category: .news, icon: "sportscourt", color: "#C4122E")
        s.id = htSubId24
        s.isActive = true
        s.createdDate = Calendar.current.date(byAdding: .month, value: -6, to: Date())!
        s.lastUsedDate = Calendar.current.date(byAdding: .day, value: -1, to: Date())!
    ...
    static var htSub25: Subscription = {
        var s = Subscription(
            name: "Skillshare Premium", description: "14-day trial - Online classes", price: 168.00,
            billingCycle: .annually, category: .education, icon: "book.fill", color: "#00FF84")
        s.id = htSubId25
        s.isFreeTrial = true
        s.trialStartDate = Date()
        s.trialEndDate = Calendar.current.date(byAdding: .day, value: 14, to: Date())
        s.trialDuration = 14
        s.willConvertToPaid = false
        s.priceAfterTrial = 168.00
        s.createdDate = Date()
        return s
    }()
        ...
        for monthOffset in 0..<12 {
            ...
            for i in 0..<transactionCount {
                ...
                let transactionDate = calendar.date(
                    byAdding: .day, value: -dayOffset, to: monthDate)!
                ...
                let transaction = Transaction(
                    ...
                    isRecurring: template.3 == TransactionCategory.bills
                        || template.3 == TransactionCategory.entertainment,
            ...
            let rentDate = calendar.date(
                from: DateComponents(
                    year: calendar.component(.year, from: monthDate),
                    month: calendar.component(.month, from: monthDate), day: 1))!
    ...
    static var htGroup01: Group = {
        var g = Group(
            name: "Beach Vacation 2024", description: "Summer trip to Malibu with friends",
            emoji: "🏖️",
            members: [htPersonId01, htPersonId02, htPersonId03, htPersonId04, htPersonId05])
        g.id = htGroupId01
        g.expenses = [
            GroupExpense(
                title: "Airbnb Beach House", amount: 1200.00, paidBy: htPersonId01,
                splitBetween: [
                    htPersonId01, htPersonId02, htPersonId03, htPersonId04, htPersonId05,
                ], category: .travel, notes: "4 nights"),
            GroupExpense(
                title: "Surfboard Rentals", amount: 250.00, paidBy: htPersonId02,
                splitBetween: [
                    htPersonId01, htPersonId02, htPersonId03, htPersonId04, htPersonId05,
                ], category: .entertainment),
            GroupExpense(
                title: "Seafood Dinner", amount: 350.00, paidBy: htPersonId03,
                splitBetween: [
                    htPersonId01, htPersonId02, htPersonId03, htPersonId04, htPersonId05,
                ], category: .dining),
            GroupExpense(
                title: "Groceries", amount: 180.00, paidBy: htPersonId04,
                splitBetween: [
                    htPersonId01, htPersonId02, htPersonId03, htPersonId04, htPersonId05,
                ], category: .groceries),
            GroupExpense(
                title: "Beach Equipment", amount: 120.00, paidBy: htPersonId05,
                splitBetween: [
                    htPersonId01, htPersonId02, htPersonId03, htPersonId04, htPersonId05,
                ], category: .shopping),
            GroupExpense(
                title: "Gas for Trip", amount: 150.00, paidBy: htPersonId01,
                splitBetween: [
                    htPersonId01, htPersonId02, htPersonId03, htPersonId04, htPersonId05,
                ], category: .transportation),
        ]
    ...
    static var htGroup02: Group = {
        var g = Group(
            name: "Monthly Dinner Club", description: "Friends who love food", emoji: "🍽️",
            members: [htPersonId01, htPersonId06, htPersonId07, htPersonId03])
        g.id = htGroupId02
        g.expenses = [
            GroupExpense(
                title: "Italian Restaurant", amount: 220.00, paidBy: htPersonId01,
                splitBetween: [htPersonId01, htPersonId06, htPersonId07, htPersonId03],
                category: .dining),
            GroupExpense(
                title: "Sushi Night", amount: 280.00, paidBy: htPersonId06,
                splitBetween: [htPersonId01, htPersonId06, htPersonId07, htPersonId03],
                category: .dining),
            GroupExpense(
                title: "Thai Cuisine", amount: 195.00, paidBy: htPersonId07,
                splitBetween: [htPersonId01, htPersonId06, htPersonId07, htPersonId03],
                category: .dining),
            GroupExpense(
                title: "French Bistro", amount: 195.00, paidBy: htPersonId03,
                splitBetween: [htPersonId01, htPersonId06, htPersonId07, htPersonId03],
                category: .dining),
        ]
    ...
    static var htGroup03: Group = {
        var g = Group(
            name: "Office Lunch Group", description: "Daily lunch crew", emoji: "💼",
            members: [
                htPersonId13, htPersonId14, htPersonId15, htPersonId16, htPersonId17, htPersonId01,
            ])
        g.id = htGroupId03
        g.expenses = [
            GroupExpense(
                title: "Monday Pizza", amount: 85.00, paidBy: htPersonId13,
                splitBetween: [
                    htPersonId13, htPersonId14, htPersonId15, htPersonId16, htPersonId17,
                    htPersonId01,
                ], category: .dining),
            GroupExpense(
                title: "Tuesday Tacos", amount: 72.00, paidBy: htPersonId14,
                splitBetween: [
                    htPersonId13, htPersonId14, htPersonId15, htPersonId16, htPersonId17,
                    htPersonId01,
                ], category: .dining),
            GroupExpense(
                title: "Wednesday Salads", amount: 68.00, paidBy: htPersonId15,
                splitBetween: [
                    htPersonId13, htPersonId14, htPersonId15, htPersonId16, htPersonId17,
                    htPersonId01,
                ], category: .dining),
            GroupExpense(
                title: "Thursday Burgers", amount: 92.00, paidBy: htPersonId16,
                splitBetween: [
                    htPersonId13, htPersonId14, htPersonId15, htPersonId16, htPersonId17,
                    htPersonId01,
                ], category: .dining),
    ...
    static var htGroup04: Group = {
        var g = Group(
            name: "Road Trip Crew", description: "Cross-country adventure", emoji: "🚗",
            members: [htPersonId01, htPersonId02, htPersonId04, htPersonId06])
        g.id = htGroupId04
        g.expenses = [
            GroupExpense(
                title: "Car Rental", amount: 450.00, paidBy: htPersonId01,
                splitBetween: [htPersonId01, htPersonId02, htPersonId04, htPersonId06],
                category: .transportation, isSettled: true),
            GroupExpense(
                title: "Gas - Leg 1", amount: 120.00, paidBy: htPersonId02,
                splitBetween: [htPersonId01, htPersonId02, htPersonId04, htPersonId06],
                category: .transportation, isSettled: true),
            GroupExpense(
                title: "Motel Stays", amount: 360.00, paidBy: htPersonId04,
                splitBetween: [htPersonId01, htPersonId02, htPersonId04, htPersonId06],
                category: .travel, isSettled: true),
            GroupExpense(
                title: "Food & Snacks", amount: 270.00, paidBy: htPersonId06,
                splitBetween: [htPersonId01, htPersonId02, htPersonId04, htPersonId06],
                category: .dining, isSettled: true),
        ]
    ...
    static var htGroup05: Group = {
        var g = Group(
            name: "Game Night", description: "Weekly board game sessions", emoji: "🎮",
            members: [htPersonId01, htPersonId02, htPersonId03, htPersonId05, htPersonId07])
        g.id = htGroupId05
        g.expenses = [
            GroupExpense(
                title: "New Board Games", amount: 65.00, paidBy: htPersonId01,
                splitBetween: [
                    htPersonId01, htPersonId02, htPersonId03, htPersonId05, htPersonId07,
                ], category: .entertainment),
            GroupExpense(
                title: "Snacks & Drinks", amount: 45.00, paidBy: htPersonId02,
                splitBetween: [
                    htPersonId01, htPersonId02, htPersonId03, htPersonId05, htPersonId07,
                ], category: .dining),
        ]
    ...
    static var htGroup06: Group = {
        var g = Group(
            name: "Birthday Planning", description: "Surprise party for Alex", emoji: "🎂",
            members: [htPersonId01, htPersonId03, htPersonId05])
        g.id = htGroupId06
        g.expenses = [
            GroupExpense(
                title: "Venue Deposit", amount: 150.00, paidBy: htPersonId01,
                splitBetween: [htPersonId01, htPersonId03, htPersonId05], category: .entertainment),
            GroupExpense(
                title: "Cake Order", amount: 85.00, paidBy: htPersonId03,
                splitBetween: [htPersonId01, htPersonId03, htPersonId05], category: .dining),
            GroupExpense(
                title: "Decorations", amount: 55.00, paidBy: htPersonId05,
                splitBetween: [htPersonId01, htPersonId03, htPersonId05], category: .shopping),
            GroupExpense(
                title: "Gift", amount: 60.00, paidBy: htPersonId01,
                splitBetween: [htPersonId01, htPersonId03, htPersonId05], category: .shopping),
        ]
    ...
    static var htGroup07: Group = {
        var g = Group(
            name: "Apartment Expenses", description: "Shared living costs", emoji: "🏠",
            members: [htPersonId01, htPersonId02, htPersonId07])
        g.id = htGroupId07
        g.expenses = [
            GroupExpense(
                title: "December Rent Share", amount: 1800.00, paidBy: htPersonId01,
                splitBetween: [htPersonId01, htPersonId02, htPersonId07], category: .bills),
            GroupExpense(
                title: "Utilities - Dec", amount: 145.00, paidBy: htPersonId02,
                splitBetween: [htPersonId01, htPersonId02, htPersonId07], category: .bills),
            GroupExpense(
                title: "Internet - Dec", amount: 89.99, paidBy: htPersonId07,
                splitBetween: [htPersonId01, htPersonId02, htPersonId07], category: .bills),
            GroupExpense(
                title: "Cleaning Supplies", amount: 45.00, paidBy: htPersonId01,
                splitBetween: [htPersonId01, htPersonId02, htPersonId07], category: .shopping),
            GroupExpense(
                title: "November Rent", amount: 1800.00, paidBy: htPersonId02,
                splitBetween: [htPersonId01, htPersonId02, htPersonId07], category: .bills,
                isSettled: true),
            GroupExpense(
                title: "Utilities - Nov", amount: 132.00, paidBy: htPersonId07,
                splitBetween: [htPersonId01, htPersonId02, htPersonId07], category: .bills,
                isSettled: true),
        ]
    ...
    static var htGroup08: Group = {
        var g = Group(
            name: "Ski Trip 2025", description: "Planning for Colorado trip", emoji: "⛷️",
            members: [
                htPersonId01, htPersonId02, htPersonId03, htPersonId04, htPersonId05, htPersonId06,
            ])
        g.id = htGroupId08
        g.expenses = [
            GroupExpense(
                title: "Cabin Deposit", amount: 800.00, paidBy: htPersonId01,
                splitBetween: [
                    htPersonId01, htPersonId02, htPersonId03, htPersonId04, htPersonId05,
                    htPersonId06,
                ], category: .travel, notes: "50% deposit - remaining due Jan 1"),
            GroupExpense(
                title: "Lift Tickets (Group)", amount: 1800.00, paidBy: htPersonId02,
                splitBetween: [
                    htPersonId01, htPersonId02, htPersonId03, htPersonId04, htPersonId05,
                    htPersonId06,
                ], category: .entertainment),
            GroupExpense(
                title: "Equipment Rental Deposit", amount: 600.00, paidBy: htPersonId03,
                splitBetween: [
                    htPersonId01, htPersonId02, htPersonId03, htPersonId04, htPersonId05,
                    htPersonId06,
                ], category: .entertainment),
    ...
    static var heavyTestSplitBills: [SplitBill] {
        ...
        bills.append(contentsOf: [
            createSplitBill(
                title: "Sushi Dinner", amount: 180.00, paidBy: htPersonId01,
                participants: [htPersonId02, htPersonId03, htPersonId04, htPersonId05],
                allPaid: true, daysAgo: 30),
            createSplitBill(
                title: "Grocery Run", amount: 95.00, paidBy: htPersonId02,
                participants: [htPersonId01, htPersonId03], allPaid: true, daysAgo: 28),
            createSplitBill(
                title: "Team Lunch", amount: 156.00, paidBy: htPersonId13,
                participants: [
                    htPersonId14, htPersonId15, htPersonId16, htPersonId17, htPersonId01,
                ], allPaid: true, daysAgo: 25),
            createSplitBill(
                title: "Coffee Run", amount: 35.00, paidBy: htPersonId03,
                participants: [htPersonId01, htPersonId02], allPaid: true, daysAgo: 22),
            createSplitBill(
                title: "Pizza Night", amount: 78.00, paidBy: htPersonId04,
                participants: [htPersonId01, htPersonId02, htPersonId05], allPaid: true, daysAgo: 20
            ),
            createSplitBill(
                title: "Movie Tickets", amount: 64.00, paidBy: htPersonId05,
                participants: [htPersonId01, htPersonId02, htPersonId03], allPaid: true, daysAgo: 18
            ),
            createSplitBill(
                title: "Brunch", amount: 120.00, paidBy: htPersonId06,
                participants: [htPersonId01, htPersonId07, htPersonId03], allPaid: true, daysAgo: 15
            ),
            createSplitBill(
                title: "Happy Hour", amount: 95.00, paidBy: htPersonId07,
                participants: [htPersonId01, htPersonId02, htPersonId06], allPaid: true, daysAgo: 12
            ),
            createSplitBill(
                title: "Takeout Thai", amount: 68.00, paidBy: htPersonId01,
                participants: [htPersonId02, htPersonId03], allPaid: true, daysAgo: 10),
            createSplitBill(
                title: "Game Night Snacks", amount: 45.00, paidBy: htPersonId02,
                participants: [htPersonId01, htPersonId05, htPersonId07], allPaid: true, daysAgo: 8),
        ])

        // Partially Settled (10)
        bills.append(contentsOf: [
            createSplitBill(
                title: "Weekend Cabin", amount: 800.00, paidBy: htPersonId01,
                participants: [htPersonId02, htPersonId03, htPersonId04],
                partiallyPaid: [htPersonId02, htPersonId03], daysAgo: 7),
            createSplitBill(
                title: "Birthday Gift", amount: 200.00, paidBy: htPersonId03,
                participants: [htPersonId01, htPersonId04, htPersonId05],
                partiallyPaid: [htPersonId01, htPersonId04], daysAgo: 6),
            createSplitBill(
                title: "Group Dinner", amount: 180.00, paidBy: htPersonId04,
                participants: [htPersonId01, htPersonId02, htPersonId03],
                partiallyPaid: [htPersonId01], daysAgo: 5),
            createSplitBill(
                title: "Concert Tickets", amount: 450.00, paidBy: htPersonId01,
                participants: [htPersonId05, htPersonId06, htPersonId07],
                partiallyPaid: [htPersonId05], daysAgo: 5),
            createSplitBill(
                title: "Airbnb Booking", amount: 1200.00, paidBy: htPersonId02,
                participants: [htPersonId01, htPersonId03, htPersonId04],
                partiallyPaid: [htPersonId01], daysAgo: 4),
            createSplitBill(
                title: "Uber Pool", amount: 35.00, paidBy: htPersonId06,
                participants: [htPersonId01, htPersonId07], partiallyPaid: [htPersonId01],
                daysAgo: 4),
            createSplitBill(
                title: "Lunch Meeting", amount: 92.00, paidBy: htPersonId13,
                participants: [htPersonId14, htPersonId15, htPersonId16],
                partiallyPaid: [htPersonId14, htPersonId15], daysAgo: 3),
            createSplitBill(
                title: "Drinks After Work", amount: 78.00, paidBy: htPersonId14,
                participants: [htPersonId13, htPersonId15, htPersonId17],
                partiallyPaid: [htPersonId13], daysAgo: 3),
            createSplitBill(
                title: "Sports Bar Tab", amount: 145.00, paidBy: htPersonId01,
                participants: [htPersonId02, htPersonId04, htPersonId06],
                partiallyPaid: [htPersonId02], daysAgo: 2),
            createSplitBill(
                title: "Grocery Shopping", amount: 167.00, paidBy: htPersonId07,
                participants: [htPersonId01, htPersonId02], partiallyPaid: [htPersonId01],
                daysAgo: 2),
        ])
        ...
        bills.append(contentsOf: [
            createSplitBill(
                title: "Italian Dinner", amount: 220.00, paidBy: htPersonId01,
                participants: [htPersonId02, htPersonId03, htPersonId04, htPersonId05],
                allPaid: false, daysAgo: 1),
            createSplitBill(
                title: "Karaoke Night", amount: 180.00, paidBy: htPersonId05,
                participants: [htPersonId01, htPersonId02, htPersonId07], allPaid: false, daysAgo: 1
            ),
            createSplitBill(
                title: "Bowling", amount: 95.00, paidBy: htPersonId06,
                participants: [htPersonId01, htPersonId03, htPersonId05], allPaid: false, daysAgo: 1
            ),
            createSplitBill(
                title: "Escape Room", amount: 150.00, paidBy: htPersonId02,
                participants: [htPersonId01, htPersonId04, htPersonId07], allPaid: false, daysAgo: 0
            ),
            createSplitBill(
                title: "Brunch Spot", amount: 135.00, paidBy: htPersonId03,
                participants: [htPersonId01, htPersonId02, htPersonId05], allPaid: false, daysAgo: 0
            ),
            createSplitBill(
                title: "Office Supplies", amount: 67.00, paidBy: htPersonId13,
                participants: [htPersonId14, htPersonId15], allPaid: false, daysAgo: 0),
            createSplitBill(
                title: "Coffee Subscription", amount: 45.00, paidBy: htPersonId16,
                participants: [htPersonId13, htPersonId17], allPaid: false, daysAgo: 0),
            createSplitBill(
                title: "Streaming Gift", amount: 120.00, paidBy: htPersonId01,
                participants: [htPersonId08, htPersonId09], allPaid: false, daysAgo: 0),
            createSplitBill(
                title: "Family Dinner", amount: 280.00, paidBy: htPersonId08,
                participants: [htPersonId01, htPersonId09, htPersonId10, htPersonId11],
                allPaid: false, daysAgo: 0),
            createSplitBill(
                title: "Holiday Decorations", amount: 95.00, paidBy: htPersonId10,
                participants: [htPersonId01, htPersonId08, htPersonId11], allPaid: false, daysAgo: 0
            ),
        ])
    ...
    private static func createSplitBill(
        ...
        for personId in participants {
            var participant = SplitParticipant(
                personId: personId, amount: splitAmount,
                hasPaid: allPaid || partiallyPaid.contains(personId))
            if participant.hasPaid {
                participant.paymentDate = calendar.date(
                    byAdding: .hour, value: -Int.random(in: 1...48), to: Date())
            }
    ...
    static func timelineItems(for personId: UUID, personName: String) -> [PersonTimelineItem] {
        ...
        return [
            .message(
                id: UUID(), text: "Hey! Want to grab lunch this week?", isFromPerson: true,
                date: daysAgo(7)),
            .message(
                id: UUID(), text: "Sure! How about Thursday?", isFromPerson: false, date: daysAgo(7)
            ),
            .payment(
                id: UUID(), amount: 8.50, direction: .outgoing, description: "Coffee last week",
                date: daysAgo(5)),
            .paidBill(id: UUID(), personName: personName, date: daysAgo(2)),
            .splitRequest(
                id: UUID(), title: "Dinner at Restaurant",
                message:
                    "Hey! I covered dinner last night. Can you send me your share when you get a chance?",
                billTotal: 97.50, paidBy: personName, youOwe: 48.75, date: daysAgo(2)),
        ]
    }
    ...
    static var emmaWilsonTimelineItems: [PersonTimelineItem] {
        [
            .splitRequest(
                id: UUID(), title: "Dinner at Italian Place",
                message: "Hey! Can you send your share when you get a chance?", billTotal: 90.00,
                paidBy: "You", youOwe: 0, date: daysAgo(3)),
            .payment(
                id: UUID(), amount: 25.00, direction: .incoming,
                description: "Coffee reimbursement", date: daysAgo(5)),
            .message(
                id: UUID(), text: "Thanks for covering lunch yesterday!", isFromPerson: true,
                date: daysAgo(7)),
            .splitRequest(
                id: UUID(), title: "Concert tickets", message: nil, billTotal: 116.50,
                paidBy: "You", youOwe: 0, date: daysAgo(14)),
        ]
    }
    ...
    static var jamesChenTimelineItems: [PersonTimelineItem] {
        [
            .splitRequest(
                id: UUID(), title: "Basketball game tickets",
                message: "Got the tickets! Let me know when you can pay.", billTotal: 91.00,
                paidBy: "James Chen", youOwe: 45.50, date: daysAgo(2)),
            .message(
                id: UUID(), text: "No rush on the payment!", isFromPerson: true, date: daysAgo(2)),
    ...
    static var aishaPatelTimelineItems: [PersonTimelineItem] {
        [
            ...
            .payment(
                id: UUID(), amount: 35.00, direction: .outgoing, description: "Movie tickets",
                date: daysAgo(3)),
            .message(
                id: UUID(), text: "All settled! Thanks for dinner last week.", isFromPerson: true,
                date: daysAgo(5)),
        ]
    }
    ...
    static var davidKimTimelineItems: [PersonTimelineItem] {
        [
            .splitRequest(
                id: UUID(), title: "Vegas trip expenses",
                message: "Here's the breakdown from our trip!", billTotal: 360.00, paidBy: "You",
                youOwe: 0, date: daysAgo(5)),
            .reminder(id: UUID(), date: daysAgo(2)),
            .message(
                id: UUID(), text: "Will pay you back after payday!", isFromPerson: true,
                date: daysAgo(4)),
        ]
    }
    ...
    static var oliviaMartinezTimelineItems: [PersonTimelineItem] {
        [
            .splitRequest(
                id: UUID(), title: "Taylor Swift concert",
                message: "Had such an amazing time! Here's your share.", billTotal: 269.25,
                paidBy: "Olivia Martinez", youOwe: 89.75, date: daysAgo(7)),
            .payment(
                id: UUID(), amount: 50.00, direction: .outgoing,
                description: "Partial payment for concert", date: daysAgo(5)),
            .message(
                id: UUID(), text: "Thanks for organizing everything!", isFromPerson: false,
                date: daysAgo(6)),
        ]
    }
    ...
    static var lucasBrownTimelineItems: [PersonTimelineItem] {
        [
            .splitRequest(
                id: UUID(), title: "Sushi dinner", message: "Great catching up last night!",
                billTotal: 97.50, paidBy: "You", youOwe: 0, date: daysAgo(4)),
            .message(
                id: UUID(), text: "That was delicious! Same place next month?", isFromPerson: true,
                date: daysAgo(3)),
        ]
    }
    ...
    static var sophiaAndersonTimelineItems: [PersonTimelineItem] {
        [
            .splitRequest(
                id: UUID(), title: "Weekly coffee runs", message: "Coffee fund for this week",
                billTotal: 45.00, paidBy: "Sophia Anderson", youOwe: 15.00, date: daysAgo(1)),
            .payment(
                id: UUID(), amount: 15.00, direction: .outgoing, description: "Last week's coffee",
                date: daysAgo(8)),
            .message(
                id: UUID(), text: "Same order tomorrow?", isFromPerson: true, date: daysAgo(2)),
        ]
    }
    ...
    static var patriciaTimelineItems: [PersonTimelineItem] {
        [
            .message(
                id: UUID(), text: "Don't forget to call grandma this weekend!", isFromPerson: true,
                date: daysAgo(1)),
            .settlement(id: UUID(), date: daysAgo(30)),
            .message(
                id: UUID(), text: "Love you, see you at Thanksgiving!", isFromPerson: false,
                date: daysAgo(5)),
        ]
    }
    ...
    static var robertTimelineItems: [PersonTimelineItem] {
        [
            .payment(
                id: UUID(), amount: 500.00, direction: .incoming, description: "Holiday gift",
                date: daysAgo(10)),
            .message(
                id: UUID(), text: "Thanks Dad! You didn't have to!", isFromPerson: false,
                date: daysAgo(10)),
            .message(
                id: UUID(), text: "Merry Christmas! Use it for something fun.", isFromPerson: true,
                date: daysAgo(10)),
        ]
    }
    ...
    static var jenniferTimelineItems: [PersonTimelineItem] {
        [
            .splitRequest(
                id: UUID(), title: "Netflix family plan", message: "Your share for the year",
                billTotal: 225.00, paidBy: "Jennifer (Sister)", youOwe: 75.00, date: daysAgo(15)),
            .message(
                id: UUID(), text: "Added you to the account!", isFromPerson: true, date: daysAgo(15)
            ),
            .message(
                id: UUID(), text: "Thanks sis! Will Venmo you.", isFromPerson: false,
                date: daysAgo(14)),
        ]
    }
    ...
    static var michaelTimelineItems: [PersonTimelineItem] {
        [
            .splitRequest(
                id: UUID(), title: "Borrowed money", message: "Just until next paycheck",
                billTotal: 150.00, paidBy: "You", youOwe: 0, date: daysAgo(20)),
            .message(
                id: UUID(), text: "Thanks for helping out! Will pay you back soon.",
                isFromPerson: true, date: daysAgo(19)),
    ...
    static var rachelTimelineItems: [PersonTimelineItem] {
        [
            .splitRequest(
                id: UUID(), title: "Birthday dinner for Aunt Lisa",
                message: "Your share of the celebration", billTotal: 100.00,
                paidBy: "Rachel (Cousin)", youOwe: 25.00, date: daysAgo(8)),
            .message(
                id: UUID(), text: "Such a fun party! Great seeing everyone.", isFromPerson: false,
                date: daysAgo(7)),
        ]
    }
    ...
    static var sarahJohnsonTimelineItems: [PersonTimelineItem] {
        [
            .splitRequest(
                id: UUID(), title: "Lunch at the new Thai place",
                message: "Great find for our lunch spot rotation!", billTotal: 46.90, paidBy: "You",
                youOwe: 0, date: daysAgo(2)),
            .message(
                id: UUID(), text: "That pad thai was amazing!", isFromPerson: true, date: daysAgo(2)
            ),
    ...
    static var alexThompsonTimelineItems: [PersonTimelineItem] {
        [
            .splitRequest(
                id: UUID(), title: "Team lunch - quarterly celebration",
                message: "Thanks everyone for a great Q4!", billTotal: 339.00,
                paidBy: "Alex Thompson", youOwe: 67.80, date: daysAgo(3)),
            .paidBill(id: UUID(), personName: "Alex Thompson", date: daysAgo(3)),
            .message(
                id: UUID(), text: "Great team effort this quarter!", isFromPerson: false,
                date: daysAgo(3)),
        ]
    }
    ...
    static var chrisWilliamsTimelineItems: [PersonTimelineItem] {
        [
            ...
            .payment(
                id: UUID(), amount: 25.00, direction: .incoming,
                description: "Coffee run reimbursement", date: daysAgo(7)),
            .message(
                id: UUID(), text: "All squared up! Thanks!", isFromPerson: true, date: daysAgo(7)),
        ]
    }
    ...
    static var morganLeeTimelineItems: [PersonTimelineItem] {
        [
            .splitRequest(
                id: UUID(), title: "Office coffee fund",
                message: "Monthly contribution for the good beans", billTotal: 84.00, paidBy: "You",
                youOwe: 0, date: daysAgo(5)),
            .message(
                id: UUID(), text: "Best investment we've made!", isFromPerson: true,
                date: daysAgo(4)),
        ]
    }
    ...
    static var taylorDavisTimelineItems: [PersonTimelineItem] {
        [
            .splitRequest(
                id: UUID(), title: "Snack run",
                message: "Grabbed some afternoon snacks for the team", billTotal: 55.50,
                paidBy: "Taylor Davis", youOwe: 18.50, date: daysAgo(1)),
            .message(
                id: UUID(), text: "Thanks for thinking of us!", isFromPerson: false,
                date: daysAgo(1)),
        ]
    }
    ...
    static var drAmandaFosterTimelineItems: [PersonTimelineItem] {
        [
            .splitRequest(
                id: UUID(), title: "Medical copay", message: "Copay for annual checkup",
                billTotal: 200.00, paidBy: "Dr. Amanda Foster", youOwe: 200.00, date: daysAgo(14)),
            .message(
                id: UUID(), text: "Please pay at your earliest convenience.", isFromPerson: true,
                date: daysAgo(7)),
        ]
    }
    ...
    static var jakeTrainerTimelineItems: [PersonTimelineItem] {
        [
            .splitRequest(
                id: UUID(), title: "Personal training session",
                message: "Great workout today! Keep it up!", billTotal: 150.00,
                paidBy: "Jake (Personal Trainer)", youOwe: 150.00, date: daysAgo(3)),
            .message(
                id: UUID(), text: "Same time next week?", isFromPerson: true, date: daysAgo(2)),
            .message(
                id: UUID(), text: "Yes! I'll be there.", isFromPerson: false, date: daysAgo(2)),
        ]
    }
    ...
    static var mrChenLandlordTimelineItems: [PersonTimelineItem] {
        [
            .payment(
                id: UUID(), amount: 1800.00, direction: .outgoing, description: "December rent",
                date: daysAgo(1)),
            .settlement(id: UUID(), date: daysAgo(1)),
            .payment(
                id: UUID(), amount: 1800.00, direction: .outgoing, description: "November rent",
                date: daysAgo(31)),
        ]
    }
}
