...
struct BackupOptions: Sendable {
    ...
    nonisolated static let all = BackupOptions()
    nonisolated static let minimal = BackupOptions(
        includePeople: true,
        includeGroups: false,
...
struct RestoreOptions: Sendable {
    ...
    init(
        conflictResolution: ConflictResolution = .replaceWithBackup,
    ...
    nonisolated static let `default` = RestoreOptions()
}
